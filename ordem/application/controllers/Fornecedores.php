...
class Fornecedores extends CI_Controller
{
    ...
    public function edit($fornecedor_id = NULL)
    {
        if (!$fornecedor_id || !$this->core_model->get_by_id('fornecedores', array('fornecedor_id' => $fornecedor_id))) {
            ...
            if ($validado) {
                ...
                /*
            [fornecedor_id] => 1
            [fornecedor_data_cadastro] => 2020-09-03 12:50:02
            [fornecedor_razao] => Yra Tecnologia
            [fornecedor_nome_fantasia] => Yra Inc
            [fornecedor_cnpj] => 55.467.821/0001-24
            [fornecedor_ie] => 
            [fornecedor_telefone] => 
            [fornecedor_celular] => 
            [fornecedor_email] => yrainc@gmail.com
            ...
            [fornecedor_ativo] => 1
            [fornecedor_obs] => 
            [fornecedor_data_alteracao] => 2020-09-03 12:52:10
            */
    ...
    public function check_razao_social($fornecedor_razao)
    {
        ...
        if ($this->core_model->get_by_id('fornecedores', array('fornecedor_razao' => $fornecedor_razao, 'fornecedor_id !=' => $fornecedor_id))) {
            ...
            $this->form_validation->set_message('check_razao_social', 'Esse razão social já existe');
            return FALSE;
        } else {
    ...
    {
        $fornecedor_ie = $this->input->post('fornecedor_ie');

        if ($this->core_model->get_by_id('fornecedores', array('fornecedor_ie' => $fornecedor_ie, 'fornecedor_ie !=' => $fornecedor_ie))) {

            $this->form_validation->set_message('check_fornecedor_ie', 'Esse inscrição estadual já existe');
            return FALSE;
        } else {
