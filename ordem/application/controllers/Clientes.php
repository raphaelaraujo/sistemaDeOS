...
class Clientes extends CI_Controller
{
    ...
    public function edit($cliente_id = NULL)
    {
        ...
        if (!$cliente_id || !$this->core_model->get_by_id('clientes', array('cliente_id' => $cliente_id))) {
            ...
            [cliente_cpf_cnpj] => 45.825.545/4554-55
            [cliente_rg_ie] => 
            [cliente_email] => 
            [cliente_telefone] => 
            [cliente_celular] => 
            ...
            */
            ...
            $this->form_validation->set_rules('cliente_email', '', 'trim|required|valid_email|max_lenght[50]');
            $this->form_validation->set_rules('cliente_telefone', '', 'trim|max_lenght[14]');
            $this->form_validation->set_rules('cliente_celular', '', 'trim|max_lenght[15]');
