            ...
            <tbody>
              <?php foreach ($marcas as $marca) : ?>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a title="Editar marca" href="<?php echo base_url('marcas/edit/' . $marca->marca_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    <a title="Excluir marca" href="javascript(void)" data-toggle="modal" data-target="#marca-<?php echo $marca->marca_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                  </td>
                </tr>
