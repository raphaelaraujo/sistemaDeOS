            ...
            <tbody>
              <?php foreach ($servicos as $servico) : ?>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a title="Editar servico" href="<?php echo base_url('servicos/edit/' . $servico->servico_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    <a title="Excluir servico" href="javascript(void)" data-toggle="modal" data-target="#servico-<?php echo $servico->servico_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                  </td>
                </tr>
