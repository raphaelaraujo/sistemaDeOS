            ...
            <tbody>
              <?php foreach ($contas_receber as $conta) : ?>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a title="Editar conta" href="<?php echo base_url('contas_receber/edit/' . $conta->conta_receber_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a class="btn btn-danger btn-sm" href="<?php echo base_url('contas_receber/del/' . $conta->conta_receber_id) ?>">Sim</a>
                      </div>
                    </div>
                  </div>
                </div>
