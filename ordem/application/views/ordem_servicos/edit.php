        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form class="user" action="" id="form" name="form_edit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            ...
                            <table id="table_servicos" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right pr-2" style="width: 13%">Valor unitário</th>
                                        <th class="text-center" style="width: 9%">Qtd</th>
                                        <th class="" style="width: 10%">% Desc</th>
                                        <th class="text-right pr-2" style="width: 20%">Total</th>
                    ...
                    <div class="mt-3">
                        <button class="btn btn-primary btn-sm mr-2" id="btn-cadastrar-venda" form="form" <?php echo ($ordem_servico->ordem_servico_status == 1 ? 'disabled' : ''); ?>><?php echo ($ordem_servico->ordem_servico_status == 1 ? 'Ordem de serviço paga' : 'Salvar'); ?></button>
