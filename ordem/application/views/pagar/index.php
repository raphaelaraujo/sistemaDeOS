              ...
              <?php foreach ($contas_pagar as $conta) : ?>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <?php  
                    //echo ($conta->conta_pagar_status == 1 ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-warning btn-sm">Não</span>')
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a class="btn btn-danger btn-sm" href="<?php echo base_url('contas_pagar/del/' . $conta->conta_pagar_id) ?>">Sim</a>
                      </div>
                    </div>
                  </div>
                </div>
