            ...
            <tbody>
              <?php foreach ($fornecedores as $fornecedor) : ?>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a title="Editar fornecedor" href="<?php echo base_url('fornecedores/edit/' . $fornecedor->fornecedor_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    <a title="Excluir fornecedor" href="javascript(void)" data-toggle="modal" data-target="#fornecedor-<?php echo $fornecedor->fornecedor_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                  </td>
                </tr>
