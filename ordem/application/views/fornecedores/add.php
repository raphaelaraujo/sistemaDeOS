...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
        <form class="user" method="POST" name="form_add" action=<?php echo base_url('fornecedores/add')?>>
        ...
        <?php endif;?>  
          ...
          <fieldset class="mt-4 border p-2 mb-3">
            ...
            <div class="form-group row mb-3">
              <div class="col-md-4">
                ...
                <input type="text" class="form-control cnpj" name="fornecedor_cnpj" placeholder="CNPJ do fornecedor" value="<?php echo set_value('fornecedor_cnpj'); ?>">
            ...
            <div class="form-group row mb-3">
              <div class="col-md-4">
                ...
                <input type="text" class="form-control sp_celphones" name="fornecedor_celular" placeholder="Celular do fornecedor" value="<?php echo set_value('fornecedor_celular'); ?>">
                <?php echo form_error('fornecedor_celular', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-4">
                <label for="exampleInputEmail1">E-email</label>
                <input type="email" class="form-control" name="fornecedor_email" placeholder="E-mail do fornecedor" value="<?php echo set_value('fornecedor_email'); ?>">
          ...
          <fieldset class="mt-4 border p-2 mb-3">
            ...
            <div class="form-group row mb-3">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="fornecedor_endereco" value="<?php echo set_value('fornecedor_endereco'); ?>">
                <?php echo form_error('fornecedor_endereco', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-2">
                <label for="exampleInputEmail1">Número</label>
                <input type="text" class="form-control" name="fornecedor_numero_endereco" value="<?php echo set_value('fornecedor_numero_endereco'); ?>">
                <?php echo form_error('fornecedor_numero_endereco', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-4">
                <label for="exampleInputEmail1">Complemento</label>
                <input type="text" class="form-control" name="fornecedor_complemento" value="<?php echo set_value('fornecedor_complemento'); ?>">
            ...
            <div class="form-group row mb-3">
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="fornecedor_bairro" value="<?php echo set_value('fornecedor_bairro') ?>">
                <?php echo form_error('fornecedor_bairro', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-2">
                <label for="exampleInputEmail1">CEP</label>
                <input type="text" class="form-control cep" name="fornecedor_cep" value="<?php echo set_value('fornecedor_cep') ?>">
                <?php echo form_error('fornecedor_cep', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-5">
                <label for="exampleInputEmail1">Cidade</label>
                <input type="text" class="form-control" name="fornecedor_cidade" value="<?php echo set_value('fornecedor_cidade'); ?>">
                <?php echo form_error('fornecedor_cidade', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-1">
                <label for="exampleInputEmail1">UF</label>
                <input type="text" class="form-control uf" name="fornecedor_estado" value="<?php echo set_value('fornecedor_estado') ?>">
          ...
          <fieldset class="mt-4 border p-2">
            ...
            <div class="form-group row mb-3">
              ...
              <?php echo set_value('fornecedor_obs') ?>
              </textarea>
