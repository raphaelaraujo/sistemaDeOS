  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <a title="Cadastrar novo serviço" href="<?php echo base_url('categorias/add') ?>" class="btn btn-success btn-sm float-right">
            ...
            <tbody>
              <?php foreach ($categorias as $categoria) : ?>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a title="Editar categoria" href="<?php echo base_url('categorias/edit/' . $categoria->categoria_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    <a title="Excluir categoria" href="javascript(void)" data-toggle="modal" data-target="#categoria-<?php echo $categoria->categoria_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                  </td>
                </tr>
