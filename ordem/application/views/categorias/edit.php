          ...
          <fieldset class="mt-4 border p-2 mb-3">
            ...
            <div class="form-group row mb-3">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="vendedor_email" placeholder="E-mail do vendedor" value="<?php echo $vendedor->vendedor_email; ?>">
          ...
          <fieldset class="mt-4 border p-2 mb-3">
            ...
            <div class="form-group row mb-3">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="vendedor_endereco" value="<?php echo $vendedor->vendedor_endereco ?>">
                <?php echo form_error('vendedor_endereco', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-2">
                <label for="exampleInputEmail1">Número</label>
                <input type="text" class="form-control" name="vendedor_numero_endereco" value="<?php echo $vendedor->vendedor_numero_endereco ?>">
                <?php echo form_error('vendedor_numero_endereco', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-4">
                <label for="exampleInputEmail1">Complemento</label>
                <input type="text" class="form-control" name="vendedor_complemento" value="<?php echo $vendedor->vendedor_complemento ?>">
            ...
            <div class="form-group row mb-3">
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="vendedor_bairro" value="<?php echo $vendedor->vendedor_bairro ?>">
                <?php echo form_error('vendedor_bairro', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-2">
                <label for="exampleInputEmail1">CEP</label>
                <input type="text" class="form-control cep" name="vendedor_cep" value="<?php echo $vendedor->vendedor_cep ?>">
                <?php echo form_error('vendedor_cep', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-5">
                <label for="exampleInputEmail1">Cidade</label>
                <input type="text" class="form-control" name="vendedor_cidade" value="<?php echo $vendedor->vendedor_cidade ?>">
                <?php echo form_error('vendedor_cidade', '<small class="form-text text-danger">', '</small>'); ?>
              </div>
              <div class="col-md-1">
                <label for="exampleInputEmail1">UF</label>
                <input type="text" class="form-control uf" name="vendedor_estado" value="<?php echo $vendedor->vendedor_estado ?>">
          ...
          <fieldset class="mt-4 border p-2">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-3">
                ...
                <input readonly type="text" class="form-control" name="vendedor_codigo" value="<?php echo $vendedor->vendedor_codigo ?>">
              ...
              <?php echo $vendedor->vendedor_obs ?>
              </textarea>
