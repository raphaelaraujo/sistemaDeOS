            ...
            <tbody>
              <?php foreach ($vendedores as $vendedor) : ?>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a title="Editar vendedor" href="<?php echo base_url('vendedores/edit/' . $vendedor->vendedor_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    <a title="Excluir vendedor" href="javascript(void)" data-toggle="modal" data-target="#vendedor-<?php echo $vendedor->vendedor_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                  </td>
                </tr>
