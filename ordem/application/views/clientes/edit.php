                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-3">
                                <?php if ($cliente->cliente_tipo == 1) : ?>
                                    ...
                                    <input type="text" class="form-control cpf" name="cliente_cpf" placeholder="CPF do cliente" value="<?php echo $cliente->cliente_cpf_cnpj ?>">
                                    <?php echo form_error('cliente_cpf', '<small class="form-text text-danger">', '</small>'); ?>
                                <?php else : ?>
                                    <label for="exampleInputEmail1">CNPJ</label>
                                    <input type="text" class="form-control cnpj" name="cliente_cnpj" placeholder="CNPJ do cliente" value="<?php echo $cliente->cliente_cpf_cnpj ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <?php endif; ?>
                                <input type="text" class="form-control" name="cliente_rg_ie" placeholder="<?php echo ($cliente->cliente_tipo == 1 ? 'RG' : 'I.E. do cliente') ?>" value="<?php echo $cliente->cliente_rg_ie ?>">
                    ...
                    <fieldset class="mt-4 border p-2 mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control" name="cliente_cidade" value="<?php echo $cliente->cliente_cidade ?>">
