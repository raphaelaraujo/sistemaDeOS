                        ...
                        <tbody>
                            <?php foreach ($clientes as $cliente) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a title="Editar cliente" href="<?php echo base_url('clientes/edit/' . $cliente->cliente_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                                        <a title="Excluir cliente" href="javascript(void)" data-toggle="modal" data-target="#cliente-<?php echo $cliente->cliente_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                                    </td>
                                </tr>
