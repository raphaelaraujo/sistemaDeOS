  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <a title="Cadastrar nova forma de pagamento" href="<?php echo base_url('formas_pagamentos/add') ?>" class="btn btn-success btn-sm float-right">
            ...
            <tbody>
              <?php foreach ($formas_pagamentos as $forma_pagamento) : ?>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo ($forma_pagamento->forma_pagamento_aceita_parc == 1 ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>') ?></td>
                  ...
                  <td class="text-right">
                    <a title="Editar forma_pagamento" href="<?php echo base_url('formas_pagamentos/edit/' . $forma_pagamento->forma_pagamento_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    <a title="Excluir forma_pagamento" href="javascript(void)" data-toggle="modal" data-target="#forma_pagamento-<?php echo $forma_pagamento->forma_pagamento_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                  </td>
                </tr>
