...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('/'); ?>">
        ...
        <div class="sidebar-brand-text mx-3">SGM</div>
    </a>
...
<!--                <a title="Gerenciar fornecedores" class="collapse-item" href="<?php echo base_url('fornecedores') ?>">
    ...
    <!--<li class="nav-item">
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a title="Gerenciar ordem de serviços" class="collapse-item" href="<?php echo base_url('vendas') ?>">
                    <i class="fas fa-shopping-cart"></i>
                    &nbsp;&nbsp;&nbsp;Vendas
                </a>
            </div>
        ...
        <!--        <li class="nav-item">
                    ...
                    <div id="collapseSix" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a title="Gerar relatório de contas a pagar" class="collapse-item" href="<?php echo base_url('relatorios/pagar') ?>">
                                <i class="fas fa-money-bill-alt"></i>
                                &nbsp;&nbsp;&nbsp;Contas a pagar
                            </a> 
    ...
    <?php if ($this->ion_auth->is_admin()) : ?>
        ...
        <li class="nav-item">
            <a title="Gerenciar Perfis" class="nav-link" href="<?php echo base_url('perfil') ?>">
